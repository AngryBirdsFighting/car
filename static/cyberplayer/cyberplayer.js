! function(a, b) {
	...
	return function(a) {
		...
		d = [c(8), c(1), c(63), c(27), c(15), c(40), c(65), c(62), c(42), c(122), c(125), c(123)], void 0 !== (e = function(a, b, c, d, e, g, h, i, j, k, l, m) {
			...
			}, n.indexOf = b.indexOf, n.noop = function() {}, n.seconds = a.seconds, n.prefix = a.prefix, n.suffix = a.suffix, b.extend(n, g, h, j, c, i, d, e, k, l, m), n
		}.apply(b, d)) && (a.exports = e)
	}, function(a, b, c) {
		var d, e, f = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
			return typeof a
			...
			return f.registerProvider = function(c) {
				...
				reorderProviders: function() {
					...
					"flash" === this.config.primary && (a = e.indexOf(this.providers, e.findWhere(this.providers, {
						...
						name: "html5"
					})), this.providers.splice(c, 0, b)), "videojs" === this.config.primary && (a = e.indexOf(this.providers, e.findWhere(this.providers, {
						name: "flash"
					})), b = this.providers.splice(a, 1)[0], c = e.indexOf(this.providers, e.findWhere(this.providers, {
						name: "html5"
					})), d = this.providers.splice(c, 1)[0], this.providers.push(d), this.providers.push(b)), "justflash" === this.config.primary && (a = e.indexOf(this.providers, e.findWhere(this.providers, {
						name: "flash"
		...
		d = [c(2), c(20), c(45), c(85), c(1), c(3), c(124), c(4), c(7), c(76)], void 0 !== (e = function(a, b, c, d, e, f, g, h, i, j) {
			var k = function() {
					...
					this.mediaController = e.extend({}, f), this.mediaModel = new l, this.advManage = null, d.model(this), this.set("mediaModel", this.mediaModel), this.setup = function(b) {
						...
						a.starttime = this.getLastPosition(a), void 0 !== this.get("starttime") && (a.starttime = this.get("starttime")), this.set("position", a.starttime || 0), this.set("duration", a.duration || 0), this.mediaModel.set("playAttempt", !0), this.mediaController.trigger(h.JWPLAYER_MEDIA_PLAY_ATTEMPT, {
					...
					switch(o && "object" === (void 0 === o ? "undefined" : f(o)) && "function" == typeof o.toJSON && (o = o.toJSON(a)), "function" == typeof j && (o = j.call(d, a, o)), void 0 === o ? "undefined" : f(o)) {
						...
						case "object":
							...
							if(j && "object" === (void 0 === j ? "undefined" : f(j)))
								...
								for(i in o) Object.prototype.hasOwnProperty.call(o, i) && (k = c(i, o)) && m.push(b(i) + (g ? ": " : ":") + k);
							return k = 0 === m.length ? "{}" : g ? "{\n" + g + m.join(",\n" + g) + "\n" + n + "}" : "{" + m.join(",") + "}", g = n, k
					}
				}
					...
					setContainer: function(e) {
						if(q !== e) {
							...
							r.on(c.JWPLAYER_MEDIA_LEVELS, function(a) {
								...
								g.trigger.call(D, "connectFaild", a), g.trigger.call(D, c.JWPLAYER_MEDIA_ERROR, {
									message: "连接已断开，请稍后重试"
								})
			...
			function m(m, x) {
				...
				function Q() {
					if(ya) {
						...
						var a = "加载失败: 不能播放当前文件";
						b.isMobile() && b.isHls(Ma.src) && Ka.tokenEncrypt && !b.isFlvjsSupported() && (a = "当前系统及浏览器环境不支持“token加密”的hls视频播放"), sa.trigger(e.JWPLAYER_MEDIA_ERROR, {
							message: a,
							code: "111",
							detail: Ma.error,
							videoSrc: Ma.src
				...
				function ma() {
					if("hls" === ra[0].type) {
						var a = "video";
						0 === Ma.videoHeight && (a = "audio"), sa.trigger("mediaType", {
							mediaType: a
						})
					}
				}
				...
				Ma = Ma || document.createElement("video"), Ma.className = "jw-video jw-reset", this.isSDK = Ba, this.itemTracks = Ha, this.video = Ma, d.isObject(x.cast) && x.cast.appid && Ma.setAttribute("disableRemotePlayback", ""), j(ta, Ma), u || (Ma.controls = !0, Ma.controls = !1), Ma.setAttribute("disableRemotePlayback", ""), Ma.setAttribute("x-webkit-airplay", "allow"), Ma.setAttribute("webkit-playsinline", ""), Ma.setAttribute("playsinline", ""), Ma.setAttribute("x5-playsinline", ""), this.stop = function() {
					...
					if(ya)
						if(a < 0 && (a += Y() + Z()), 0 === va && this.trigger(e.JWPLAYER_MEDIA_SEEK, {
		...
		d = [c(73), c(1), c(20), c(60), c(34)], void 0 !== (e = function(a, b, c, d, e) {
			var f = [],
				...
				h = function(b) {
					var c, d;
					return b ? "string" == typeof b ? (c = i(b)) || (d = document.getElementById(b)) : "number" == typeof b ? c = f[b] : b.nodeType && (d = b, c = i(d.id)) : c = f[0], c || (d ? j(new a(d, k)) : {
		...
		d = [c(2), c(25), c(4), c(3), c(41), c(1)], void 0 !== (e = function(a, b, c, d, e, g) {
			...
			return function(i) {
				...
				function l() {
					r = e.loaderstatus.ERROR, q.trigger(c.ERROR, {
						url: i
					})
				}
		...
		d = [c(1), c(65), c(2), c(27)], void 0 !== (e = function(a, b, c, d) {
			...
			function f() {
				...
				if(v = -1, a) {
					...
					this.addTracksListener(a, "change", p), t && t.length && this.trigger("subtitlesTracks", {
						tracks: t
					})
				}
			}
		...
		void 0 !== (d = function(require, a, b) {
			...
			function i(a, b) {
				...
				var g = f.counter++;
				return c = f.element, d = j.bind(null, c, g, !1), e = j.bind(null, c, g, !0), d(b),
					function(a) {
						if(a) {
		...
		d = [c(2), c(1)], void 0 !== (e = function(a, b) {
			...
			return function(i, j) {
				...
				d(l);
				var m = b.extend({}, h, l);
				if(m.options = i, void 0 === m.controlbar.canDrag && (m.controlbar.canDrag = !0), "." === m.base && (m.base = a.getScriptPath("cyberplayer.js")), m.playRate || (m.playbackRate = 1), m.base = (m.base || a.loadFrom()).replace(/\/?$/, "/"), c.p = m.base, m.width = e(m.width), m.height = e(m.height), m.flashplayer = m.flashplayer || a.getScriptPath("cyberplayer.js") + "cyberplayer.flash.swf?t=" + new Date().getTime(), "http:" === window.location.protocol && (m.flashplayer = m.flashplayer.replace("https", "http")), m.aspectratio = g(m.aspectratio, m.width), b.isObject(m.skin) && (m.skinUrl = m.skin.url, m.skinColorInactive = m.skin.inactive, m.skinColorActive = m.skin.active, m.skinColorBackground = m.skin.background, m.skin = b.isString(m.skin.name) ? m.skin.name : h.skin), b.isString(m.skin) && m.skin.indexOf(".xml") > 0 && (console.log("JW Player does not support XML skins, please update your config"), m.skin = m.skin.replace(".xml", "")), m.aspectratio || delete m.aspectratio, !m.playlist) {
		...
		d = [c(19), c(33), c(109), c(2)], void 0 !== (e = function(a, b, c, d) {
			return function(e, f) {
				...
				function o(d, e) {
					...
					if(f)
						for("xml" === a.localName(f) && (f = f.nextSibling); f.nodeType === f.COMMENT_NODE;) f = f.nextSibling;
					try {
				...
				setup: function(g, n) {
					...
					ca.setup(ia, ha), ca.advManage && ca.advManage.setApi(n), Z = this._view = new l(n, ca), new s(n, ca), $ = new e(n, ca), _ = new d(n, ca, Z, G), _.on(q.JWPLAYER_READY, t, this), _.on(q.JWPLAYER_SETUP_ERROR, this.setupError, this), ca.mediaController.on(q.JWPLAYER_MEDIA_COMPLETE, function() {
						...
						var g = {
							...
							h = ca.get("dock");
						h = h ? h.slice(0) : [], h = c.reject(h, c.matches({
							id: g.id
						})), h.push(g), ca.set("dock", h)
		...
		d = [c(19), c(8), c(2)], void 0 !== (e = function(a, b, c) {
			return function(d, e) {
				...
				if(f.length)
					for(e.sources = [], l = 0; l < f.length; l++) f[l].file.length > 0 && (f[l][i] = "true" === f[l][i], f[l].label.length || delete f[l].label, e.sources.push(f[l]));
				if(g.length)
					for(e.tracks = [], l = 0; l < g.length; l++) g[l].file.length > 0 && (g[l][i] = "true" === g[l][i], g[l].kind = g[l].kind.length ? g[l].kind : "captions", g[l].label.length || delete g[l].label, e.tracks.push(g[l]));
				return e
			}
		}.apply(b, d)) && (a.exports = e)
	}, function(a, b, c) {
		...
		d = [c(19), c(8), c(2)], void 0 !== (e = function(a, b, c) {
			...
			return function i(a, b) {
				var j, k, l = "tracks",
					m = [];
				for(k = 0; k < h(a); k++)
					if(j = a.childNodes[k], "media" === j.prefix) {
						if(!f(j)) continue;
		...
		d = [c(15), c(2), c(27), c(1), c(4), c(7), c(26), c(3), c(61)], void 0 !== (e = function(a, b, c, d, e, f, g, h, i) {
			...
			function l(l, w) {
				...
				function Q(a) {
					pa = a, xa = R(a);
					var b = P(a);
					b && qa.trigger(e.JWPLAYER_MEDIA_LEVELS, {
						levels: b,
						currentQuality: xa
					})
				}
				...
				function Y() {
					qa.trigger("volume", {
						volume: Math.round(100 * Ha.volume)
					}), qa.trigger("mute", {
						mute: Ha.muted
					})
				}
				...
				function ca() {
					for(var a = -1, b = 0; b < Ha.audioTracks.length; b++)
						if(Ha.audioTracks[b].enabled) {
							a = b;
							break
						}
					ha(a)
				...
				Ha = Ha || document.createElement("video"), Ha.className = "jw-video jw-reset", m = window.videojs(Ha), this.isSDK = ya, this.itemTracks = Ea, this.video = Ha, d.isObject(w.cast) && w.cast.appid && Ha.setAttribute("disableRemotePlayback", ""), j(ra, Ha), Ha.controls = !0, Ha.controls = !1, Ha.setAttribute("disableRemotePlayback", ""), Ha.setAttribute("x-webkit-airplay", "allow"), Ha.setAttribute("webkit-playsinline", ""), Ha.setAttribute("playsinline", ""), Ha.setAttribute("x5-playsinline", ""), this.stop = function() {
					...
					if(wa)
						if(a < 0 && (a += V() + W()), 0 === ta && this.trigger(e.JWPLAYER_MEDIA_SEEK, {
					...
					}), m.on(e.JWPLAYER_ERROR, O), m.tech({
						IWillNotUseThisInPlugins: !0
					...
					if("uniform" === d) {
						var f = b / c,
							g = Ha.videoWidth / Ha.videoHeight;
						Math.abs(f - g) < .09 && (e.objectFit = "fill", d = "exactfit")
					}
					...
					if(!(xa === a || a < 0))
						if(b.isMutipleHls(pa)) {
							xa = a, this.trigger(e.JWPLAYER_MEDIA_LEVEL_CHANGED, {
								currentQuality: a,
								levels: P(pa)
							});
							var c = Ha.currentTime || 0,
								d = Ha.duration || 0;
					...
					n.isLive || (Ha.playbackRate = a, this.trigger(e.JWPLAYER_PLAYBACKRATE, {
						playbackRate: a
					}))
				}
			}
			var m, n, o, p = window.clearTimeout,
				q = 256,
				r = b.isMSIE(),
				s = b.isFF(),
				t = !1,
		...
		d = [c(2), c(3), c(1)], void 0 !== (e = function(a, b, c) {
			...
			function e(e, g, j, k, l, m) {
				...
				return n.className = "jw-swf jw-reset",
					n.style.display = "block", n.style.position = "absolute", n.style.left = 0, n.style.right = 0, n.style.top = 0, n.style.bottom = 0, c.extend(n, b), n.queueCommands = !0, n.triggerFlash = function(b) {
						var d = this;
			...
			return b.extend(p.prototype, c, {
				...
				onMediaModel: function(c, d) {
					d.on("change:levels", function(a, b) {
						...
						var c = this._model.get("playRateConfig"),
							d = c.findIndex(function(a) {
								return a.label === "×" + b
							});
		...
		d = [c(2), c(1), c(15)], void 0 !== (e = function(a, b, c) {
			...
			return b.extend(e.prototype, {
				init: function() {
					...
					b && (this.element.innerHTML = b), d && c.style(this.element, {
						color: d
				...
				stop: function() {
					this.reset(), c.style(this.element, {
				...
				randomTop: function() {
					var a = 0;
					this.model.get("containerHeight") && (a = this.model.get("containerHeight")), c.style(this.element, {
						top: d(a)
					})
				}
			}), e
		...
		d = [c(1), c(2)], void 0 !== (e = function(a, b) {
			...
			return a.extend(e.prototype, {
				...
				setImage: function(c) {
					...
					var e = "";
					a.isString(c) && (e = 'url("' + c + '")', d = this.image = new Image, d.src = c), b.isPoorIE() ? this.el.style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + c + '",sizingMethod="scale"' : b.style(this.el, {
						backgroundImage: e
					})
				},
		...
		d = [c(2), c(4), c(3), c(21), c(7), c(128), c(129), c(138), c(139), c(141), c(137), c(143), c(127), c(142), c(144), c(145), c(1), c(172)], void 0 !== (e = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
			...
			return function(w, x) {
				...
				function S() {
					...
					a.addEventListener(c, "mousemove", ca), va = new g(x, na, {
						useHover: !0
					}), va.on("click", function() {
						P({
							type: b.JWPLAYER_DISPLAY_CLICK
						}), x.get("controls") && !x.get("flashUI") && w.play({
							reason: "interaction"
						})
					}), va.on("tap", function() {
						P({
				...
				function V(b, c, d) {
					...
					d = !!d, d && (f = f.replace(/\s*aspectMode/, ""), la.className !== f && (la.className = f), a.style(la, {
						display: "block"
					}, d)), a.exists(b) && a.exists(c) && (x.set("width", b), x.set("height", c)), e = {
						width: b
					}, a.hasClass(la, "jw-flag-aspect-mode") || (e.height = c), s(la, e, !0), W(c), Z(b, c)
				}
				...
				var la, ma, na, oa, pa, qa, ra, sa, ta, ua, va, wa, xa, ya, za, Aa, Ba, Ca, Da, Ea, Fa, Ga = -1,
					...
					Oa = !1,
					Pa = q.extend(this, c);
				this.model = x, this.api = w, la = a.createElement(r({
					id: x.get("id")
				})), a.isIE() && a.addClass(la, "jw-ie"), a.isPoorIE() && a.addClass(la, "jw-ie-poorie"), x.get("flashUI") && a.addClass(la, "jw-flashui");
				var Qa = x.get("width"),
					Ra = x.get("height");
				s(la, {
					...
					w.on(b.JWPLAYER_READY, function() {
						...
						w.stop(), a.toggleClass(la, "jw-flag-live", !0), a.getElementsByClassName("jw-controlbar", la)[0].style.display = "block"
					}), x.on("alive", function() {
						"idle" !== Pa.model.get("state") && (
						a.toggleClass(la, "jw-flag-live", !0), c.style.display = "none")
					}), x.on("noLiveStream", function() {
						"idle" !== Pa.model.get("state") && x.get("isLive") && (
						a.toggleClass(la, "jw-flag-live", !0), x.get("image") && (c.style.display = "block"), a.getElementsByClassName("jw-controlbar", la)[0].style.display = "block")
					}), x.on("liveStop", function() {
						w.stop(), 
						a.toggleClass(la, "jw-flag-live", !0), a.getElementsByClassName("jw-controlbar", la)[0].style.display = "block"
					}), x.on("seekAfterLoadSuccess", function() {
						a.addClass(ra.element(), "jw-controlbar-textshow"), setTimeout(function() {
		...
		b["default"] = function(a) {
			a.registerHelper("each", function(a, b) {
				...
				var e = b.fn,
					...
					j = void 0,
					k = void 0;
				if(b.data && b.ids && (k = d.appendContextPath(b.data.contextPath, b.ids[0]) + "."), d.isFunction(a) && (a = a.call(this)), b.data && (j = d.createFrame(b.data)), a && "object" == typeof a)
					if(d.isArray(a))
		...
		"string" == typeof d && (d = [
			["all-players", d, ""]
		]), c(68).style(d, "all-players"), d.locals && (a.exports = d.locals)
	}, function(a, b) {
