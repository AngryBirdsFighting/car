...
<template>
	<div>
		...
		<el-menu :default-active="activeMenu" mode="horizontal" :default-openeds="defaultOpeneds" 
			:unique-opened="true" class="el-menu-vertical-demo" background-color="#fff" text-color="#7d7d7d" active-text-color="#7d7d7d"
			v-loading="menuLoad"
